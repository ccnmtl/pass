...
urlpatterns = patterns(
    ...
    (r'^admin/_clear_state/$',
     'pass.main.views.clear_state'),
    ('^admin/allresults/$', 'main.views.all_results'),
    ('^admin/allresultskey/$',
     'main.views.all_results_key'),
    (r'^admin/reports/(?P<path>.*)$',
     'pass.main.views.reports'),
    ...
    (r'^_careerlocation/', include('careerlocation.urls')),
    (r'^_stats/',
