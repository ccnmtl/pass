...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CareerLocationStrategyBlock.questioner'
        db.add_column('careerlocation_careerlocationstrategyblock', 'questioner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['careerlocation.Actor'], null=True, blank=True), keep_default=False)

        # Adding M2M table for field strategy_responses on 'CareerLocationState'
        db.create_table('careerlocation_careerlocationstate_strategy_responses', (
        ...
        db.create_unique('careerlocation_careerlocationstate_strategy_responses', ['careerlocationstate_id', 'actorresponse_id'])


    def backwards(self, orm):
        
        # Deleting field 'CareerLocationStrategyBlock.questioner'
        db.delete_column('careerlocation_careerlocationstrategyblock', 'questioner_id')

        # Removing M2M table for field strategy_responses on 'CareerLocationState'
        db.delete_table('careerlocation_careerlocationstate_strategy_responses')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 22, 8, 44, 18, 423092)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 22, 8, 44, 18, 423008)'}),
