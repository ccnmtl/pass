...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MapLayer.z_index'
        db.add_column('careerlocation_maplayer', 'z_index', self.gf('django.db.models.fields.IntegerField')(default=999), keep_default=False)

        # Adding field 'MapLayer.transparency'
        db.add_column('careerlocation_maplayer', 'transparency', self.gf('django.db.models.fields.IntegerField')(default=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MapLayer.z_index'
        db.delete_column('careerlocation_maplayer', 'z_index')

        # Deleting field 'MapLayer.transparency'
        db.delete_column('careerlocation_maplayer', 'transparency')
