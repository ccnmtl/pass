...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Strategy.question'
        db.add_column('careerlocation_strategy', 'question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['careerlocation.ActorQuestion'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Strategy.question'
        db.delete_column('careerlocation_strategy', 'question_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 22, 8, 56, 27, 63824)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 22, 8, 56, 27, 63730)'}),
