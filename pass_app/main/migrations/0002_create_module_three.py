...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        hierarchy = Hierarchy(name='module-three', base_url='/module-three/')
        hierarchy.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 13, 13, 11, 28, 174793)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 13, 13, 11, 28, 174705)'}),
