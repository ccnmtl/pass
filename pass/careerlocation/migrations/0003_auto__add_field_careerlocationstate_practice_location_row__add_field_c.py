...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CareerLocationState.practice_location_row'
        db.add_column('careerlocation_careerlocationstate', 'practice_location_row', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CareerLocationState.practice_location_column'
        db.add_column('careerlocation_careerlocationstate', 'practice_location_column', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CareerLocationState.practice_location_row'
        db.delete_column('careerlocation_careerlocationstate', 'practice_location_row')

        # Deleting field 'CareerLocationState.practice_location_column'
        db.delete_column('careerlocation_careerlocationstate', 'practice_location_column')
